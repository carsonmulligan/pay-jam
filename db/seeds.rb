...
seca = Dish.create(name: 'Tacos de Carne Assada com Salsa Seca', description: 'Thick slice of tenderloin grilled and served with grind mixture of fried garlic & chile arbol.', price: 10.90, category: 'Tacos', restaurant: el_taco)
file = URI.open('https://res.cloudinary.com/didajvmh1/image/upload/v1654093050/PRATOS/tacospollo_vhnusy.png')
seca.photo.attach(io: file, filename: "#{seca.name}.png", content_type: 'image/png')


fajita = Dish.create(name: 'Fajita', description: 'Grilled meat, bell pepper served as a taco on corn tortilla with lime, avocado and sour crème.', price: 10.90, category: 'Tacos', restaurant: el_taco)
...
# vegetarian specials
preto = Dish.create(name: 'Feijão Preto', description: 'Refried black beans serves with fresh queso and salsa mayonnaise chipotle.', price: 9.90, category: 'Vegetarian Specials', restaurant: el_taco)
...
hongos = Dish.create(name: 'Hongos al Ajillo', description: 'Mushrooms with chilli guagillo flavoured with fried garlic.', price: 10.00, category: 'Vegetarian Specials', restaurant: el_taco)
...
# burritos
frango = Dish.create(name: 'Burritos com Frango Assado', description: 'Grilled chicken wrapped in traditional mexican handmade tortilla with refried beans and queso.', price: 10.50, category: 'Burritos', restaurant: el_taco)
...
vazia = Dish.create(name: 'Burritos com Vazia', description: 'Grilled vazia de novilho wrapped in traditional Mexican homemade tortilla with refried beans and queso.', price: 11.90, category: 'Burritos', restaurant: el_taco)
...
# drinks
corona = Dish.create(name: 'Corona Extra', description: 'Mexican beer 4.5% vol.', price: 3.85, category: 'Drinks', restaurant: el_taco)
...
modelo = Dish.create(name: 'Modelo Especial', description: 'Mexican beer alc 4.5 % , 35.5 cl.', price: 4.10, category: 'Drinks', restaurant: el_taco)
...
somersby = Dish.create(name: 'Somersby', description: 'Apple sparkling Cider alc. 4.5 % vol. 33cl.', price: 3.85, category: 'Drinks', restaurant: el_taco)
...
clara = Dish.create(name: 'Pacifico Clara', description: 'Mexican beer. alc. 4.5 % vol..35.5 cl.', price: 4.10, category: 'Drinks', restaurant: el_taco)
...
desperados = Dish.create(name: 'Desperados', description: 'Beer flavoured with Tequla alc. 5.9 % vol 33cl.', price: 4.10, category: 'Drinks', restaurant: el_taco)
...
sagres = Dish.create(name: 'Sagres', description: 'Portuguese beer with alc 5.0 % vol 33cl.', price: 3.00, category: 'Drinks', restaurant: el_taco)
...
caipi = Dish.create(name: 'Caipirinha', description: ' Classic Brazilian drink.', price: 3.00, category: 'Drinks', restaurant: el_taco)
...
maracuja = Dish.create(name: 'Caipirinha com Maracuja', description: ' Classic Brazilian drink.', price: 3.00, category: 'Drinks', restaurant: el_taco)
...
# desserts
churros = Dish.create(name: 'Churros', description: 'Sweet Mexican dessert with brown sugar and chocalate sauce', price: 3.90, category: 'desserts', restaurant: el_taco)
